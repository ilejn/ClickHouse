...
CREATE ROW POLICY db1_01295 ON db.* USING 1 AS PERMISSIVE TO ALL;
CREATE ROW POLICY tbl1_01295 ON db.table USING 1 AS PERMISSIVE TO ALL;
SELECT '  -- SHOW CREATE POLICY db1_01295 ON db.*';
SHOW CREATE POLICY db1_01295 ON db.*;
SELECT '  -- SHOW CREATE POLICY ON db.*';
SHOW CREATE POLICY ON db.*;
SELECT '  -- SHOW CREATE POLICY ON db.`*`';
SHOW CREATE POLICY ON db.`*`;
